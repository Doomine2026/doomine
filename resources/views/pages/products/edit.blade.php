                ...
                <div class="grid grid-cols-3  gap-5 m-2">
                  @foreach ($product->images as $item)
                    <div id="portada-{{ $item->id }}" class="relative group shadow-xl">
                      ...
                      <!-- Imagen -->
                      <img src="{{ asset($item->name_imagen) }}" alt="{{ $item->producto->producto ?? 'Producto' }}"
                        class="w-24 hover:blur-sm"
                    ...
                    <div id='combination-{{ $item->id }}'
                      ...
                      <div class="mb-2 mt-2">
                        @component('components.selectStock', [
                            ...
                            'id' => 1,
                            'class' =>
                                'mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
                            'options' => $valorAtributo,
                            'defaultValue' => 1,
                            'value' => 'id',
                            'label' => 'valor',
                      ...
                      <div class="mb-2 mt-2">
                        <input type="text" name="conbinacion-{{ $item->id }}[sku]" placeholder="sku"
                          value="{{ $item->sku }}" id="stock-2"
                          class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      </div>
                      <button
